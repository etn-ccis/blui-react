...
| overlay           | Enable translucent gradient and blur overlay | `boolean`                                 | no       | `false`       |
...
> **Note:** For the MUI AppBar to enable overlay, pass `variant="overlay"` with `color="transparent"`. 
