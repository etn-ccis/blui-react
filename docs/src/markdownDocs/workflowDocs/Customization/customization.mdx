...
A similar prop exists for `existingAccountSuccessScreen` which will be used if the account being registered already exists.Refer [Existing Account Success Screen](/workflows/screens/existing-account-success/).
