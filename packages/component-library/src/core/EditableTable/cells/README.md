# EditableTable Cell Components

This directory contains the cell components used by EditableTable for rendering and editing different data types.

## Cell Types

The EditableTable supports 4 cell types, specified via the `cellType` property in column definitions:
