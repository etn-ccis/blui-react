...
type DataPointCommandDialogProps = {
...
export const DataPointCommandDialog = ({
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        try {
            const response = await EdgeXAPI.putCommandEvent(device, deviceResource.name, {
    ...
    return (
        ...
        >
            ...
            <DialogTitle>{deviceResource.name}</DialogTitle>
            <TextField
                autoFocus
                required
