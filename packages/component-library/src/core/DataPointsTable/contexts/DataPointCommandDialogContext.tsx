...
const DialogContainer = ({ children, closeDialog, ...props }: PropsWithChildren<DialogContainerProps>): JSX.Element => (
    <Dialog {...props} onClose={closeDialog}>
        {children}
    </Dialog>
);

export const DataPointCommandDialogProvider = ({ children }: PropsWithChildren<object>): JSX.Element => {
