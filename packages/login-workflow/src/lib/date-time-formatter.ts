...
const formatDateTime = (dateTime: string | undefined | null, locales?: string | string[]): string =>
    dateTime ? new Date(dateTime).toLocaleString(locales) : '';

const formatMonthLong = (dateTime: string | undefined | null, locales?: string | string[]): string =>
    dateTime ? new Date(dateTime).toLocaleString(locales, { month: 'long' }) : '';

const formatDate = (dateTime: string | undefined | null, locales?: string | string[]): string =>
    dateTime ? new Date(dateTime).toLocaleDateString(locales) : '';

const formatDateShort = (dateTime: string | undefined | null, locales?: string | string[]): string =>
    dateTime
...
const formatTime = (dateTime: string | undefined | null, locales?: string | string[]): string =>
    dateTime ? new Date(dateTime).toLocaleTimeString(locales) : '';

const formatTimeShort = (dateTime: string | undefined | null, locales?: string | string[]): string =>
    dateTime
