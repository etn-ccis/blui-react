...
describe('Form validation phone number', () => {
    ...
    it('should display error for each country', () => {
        cy.get('[data-cy=country-selector]').click().should('contain', 'US');
        ...
        cy.get('[data-cy=phone-input]').click();
        cy.get('body').click(top, { force: true });
        cy.contains('Please enter a valid Canadian phone number').should(
            'contain',
        ...
        cy.get('[data-cy=phone-input]').click();
        cy.get('body').click(top, { force: true });
        cy.contains('Please enter a valid Russian phone number').should(
            'contain',
        ...
        cy.get('[data-cy=phone-input]').click();
        cy.get('body').click(top, { force: true });
        cy.contains('Please enter a valid Egyptian phone number').should(
            'contain',
        ...
        cy.get('[data-cy=phone-input]').click();
        cy.get('body').click(top, { force: true });
        cy.contains('Please enter a valid Indian phone number').should(
            'contain',
