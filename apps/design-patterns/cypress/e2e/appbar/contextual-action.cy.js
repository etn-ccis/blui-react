...
describe('Contextual App Bar', () => {
    ...
    it('should display header checkbox indeterminate', () => {
        cy.get('[data-cy=table-cell-checkbox]').first().click();
        cy.get('[data-cy=table-header-checkbox]').find('input').should('have.attr', 'data-indeterminate', 'true');
    });

    it('should not display header checkbox indeterminate', () => {
        cy.get('[data-cy=table-header-checkbox]').click();
        cy.get('[data-cy=table-header-checkbox]').find('input').should('have.attr', 'data-indeterminate', 'false');
    });
